...
def query(question: str, *, agent_name: Optional[str] = None, chat_history: Optional[list] = None) -> str:
    _load_agents()
    ...
    # 确保提供 chat_history 列表，避免 LangChain 报错
...
def query_fortune(question: str, *, return_meta: bool = False):
    from rag.pipelines.fortune_pipeline import query_fortune as _qf  # type: ignore
